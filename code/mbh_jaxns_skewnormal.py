...
if __name__ == "__main__":
    ...
    M_location, M_scale, M_shape = np.loadtxt("results/logskewnormal_params_M.txt", unpack=True)
    sigma_gc_location, sigma_gc_scale, sigma_gc_shape = np.loadtxt("results/logskewnormal_params_sigma_gc.txt", unpack=True)
    
    print("M params:", M_location, M_scale, M_shape)
    print("sigma_gc params:", sigma_gc_location, sigma_gc_scale, sigma_gc_shape)
    exit()
    M = bh_data["M"]
